...
<h2><span>TARGETS</span> list</h2>
    <div align="right" width="80%"><a href="#" onclick="show('addTgtDiv', 'name-id'); return false">Add target</a></div>
    <div align="center">
    
    <div id="addTgtDiv" width="80%" style="display: <c:choose>
             <c:when test="${not empty actionBean.context.validationErrors}">inline</c:when>
             <c:otherwise>none</c:otherwise>
    </c:choose>;">
        <stripes:form action="/actions/AddTarget">
        <stripes:errors/>
        <table style="background:#FFFFD0; border:1px dotted #DADADA;" >
            ...
            <tr>
                ...
                <td colspan="2" align="center">
                    ...
                    <stripes:submit name="cancel" value="Cancel" style="width: 7em;" onclick="hide('addTgtDiv'); return false" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <tr>
            <td width="95%">
                <p><img border="0" src="<c:url value="/images/arrow.gif" />"/>
                            <span><a href="<c:url value="/actions/ViewTarget">
                                                <c:param name="targetId" value="${target.id}" />
                                           </c:url>"><c:out value="${target.name}"/></a></p></span>
            </td>
            <td width="5%">
                <a href="<c:url value="/actions/ToggleStateTarget">
                                                <c:param name="targetId" value="${target.id}" />
